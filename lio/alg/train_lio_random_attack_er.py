...
def train(config):
    ...
    if config.lio.decentralized:
        ...
        from lio_agent_random_attack import RandomIncentiveAttackLIO as LIO_R
    list_agents = []

    
    # All agents random attack
    for agent_id in range(env.n_agents):
        list_agents.append(LIO_R(config.lio, env.l_obs, env.l_action,
...
if __name__ == '__main__':
    ...
    if args.exp == 'er':
        ...
        config.main.dir_name = 'er_all_agents_random_attack_4_2'  # Directory for exploitative agent logs
