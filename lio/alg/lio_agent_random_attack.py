...
class RandomIncentiveAttackLIO(object):
    ...
    def __init__(self, config, l_obs, l_action, nn, agent_name,
        ...
        # Positive parameters for random incentive attack, randomly guessed by hackers
        ...
        print(f"Initializing Random Incentive Attack LIO agent {self.agent_name} with energy_param: {energy_param}")
